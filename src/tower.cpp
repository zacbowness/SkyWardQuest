...
void Tower::load_filepaths(){
	...
	texture_filepaths["BrownStone"] = "res://mesh_assets/Lowpoly_Forest_Pack/Textures/OakTreeTrunk.png";
...
void Tower::build_tower(){
	...
	make_prop(Vector3(-5.37,0,-2.58), Vector3(1,1,1), Vector3(0,-14.6,0), mesh_filepaths["SM_Rock_4"], texture_filepaths["Rock_4"], "Entryway Rock");
	...
	//Floating Rocks
	make_prop(Vector3(-5.83, 8.25, -1.56), Vector3(0.14,0.14,0.14), Vector3(0,0,0), mesh_filepaths["SM_Rock_3"], texture_filepaths["BrownStone"], "Floating Rock_1");
